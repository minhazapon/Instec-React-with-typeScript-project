...
const Technology = () => {
    ...
    return (
        <div className=" mb-10 bg-no-repeat bg-cover p-28 "
        style={{
            backgroundImage: "url(https://images.unsplash.com/photo-1607799279861-4dd421887fb3?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cHJvZ3JhbW1pbmd8ZW58MHx8MHx8fDA%3D)",
          }}
        ...
        >
            ...
            <div>
                ...
                <div>
                  <p className=" text-white font-serif text-center">WHAT WE'RE OFFERING</p>
                  <p className=" font-bold bg-gradient-to-r from-white to-yellow-500 bg-clip-text text-transparent text-center mt-5 text-5xl">Get the best IT technology<br></br>
                  services & solutions</p>
                </div>
                
           

                <div className=" flex-col md:flex-row lg:flex-row flex justify-center items-center gap-2 mt-10">
